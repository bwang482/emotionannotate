...
def adapt(ci,wi,si,trfile,tfile,pfile,emo):
    source_model1='../output/embedding/'+emo+'/train.'+emo+'.model,0.7'
    source_model2='../output/lexicon/'+emo+'/train.'+emo+'.model,0.8'
    source_model3='../output/ngrams/'+emo+'/train.'+emo+'.model,2.0'
...
#    weights = [0.1,0.2,0.3,0.5,0.6,0.7,0.8,0.9,1,2,3,4,5,6,8,10]
