...
#                   'fear': [emotion_tweet_dir + 'emo_fear_raw.txt', emotion_tweet_dir + 'hash_fear_raw.txt'],
                   ...
                   'surprise': [purver_tweet_dir + 'emo_surprise_raw.txt', purver_tweet_dir + 'hash_surprise_raw.txt']},
...
#                   'fear': [emotion_tweet_dir + 'emo_nonfear_raw.txt', emotion_tweet_dir + 'hash_nonfear_raw.txt'],
                   ...
                   'surprise': [purver_tweet_dir + 'emo_nonsurprise_raw.txt', purver_tweet_dir + 'hash_nonsurprise_raw.txt']},
